...
{
    private static readonly string[] Value = ["1", "bad"];
    private static readonly string[] ValueArray = ["1", "2", "3"];
    private static readonly string[] ValueArray0 = ["1"];

    [Test]
    public void NestedFailureReportsCollectionPath()
    {
        ConversionResult<int[][]> result = ValueConverter.Default.Convert<int[][]>(new[] { Value });
    ...
    public void ItemBudgetStopsLargeCollection()
    {
        ...
        ConversionResult<int[]> result = ValueConverter.Default.Convert<int[]>(ValueArray, context);
    ...
    public void DepthBudgetStopsNestedCollection()
    {
        ...
        ConversionResult<int[][]> result = ValueConverter.Default.Convert<int[][]>(new[] { ValueArray0 }, context);
