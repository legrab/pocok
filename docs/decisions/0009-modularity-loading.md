# ADR 0009: Trusted startup modularity with isolated BCL load contexts

- Status: Accepted and implemented; experimental API maturity
- Date: 2026-07-15
...
Modularity remains releasable only while clean-room fixtures pass on Linux and Windows for:
