...
- [x] Add bounded Conversion work, explicit strategies, tests, trim sample, and benchmark project.
...
- [x] Add core sample execution and trimmed Conversion publish/run checks to CI.
