...
> **Handoff status:** no package from the generated baseline should be tagged or published until the executable acceptance sequence in `docs/plans/repository-consolidation.md` passes. Catalog release eligibility currently expresses the intended package order, not verified readiness.
