...
Result<int> strict = converter.Convert<int>("42");
Result<byte> saturated = converter.Convert<byte>(300, new ConversionContext(
...
This package is experimental alpha software. Its reviewed public surface is enforced by unit tests.
