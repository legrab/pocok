...
public sealed class ScriptRunner(IValueConverter? converter = null)
{
    ...
    private readonly Func<Action<Options>, Engine> _engineFactory = static configure => new(configure);
        ...
        foreach (ScriptBinding binding in request.Bindings)
        {
            ...
            switch (binding.Value)
            {
                ...
                case sbyte or byte or short or ushort or int or uint or long or ulong or float or double or decimal:
                    ...
                    break;
                default: throw new InvalidOperationException($"Unsupported binding type {binding.Value.GetType().FullName}.");
            }
        }
