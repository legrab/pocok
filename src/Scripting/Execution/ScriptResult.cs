...
public sealed class ScriptResult<T>
{
    ...
    /// <summary>Gets the result value. A successful script may intentionally return null.</summary>
    public T? Value { get; }

    /// <summary>Gets the expected failure, when execution did not succeed.</summary>
    public ScriptFailure? Failure { get; }
}

/// <summary>Creates script results without requiring static members on a generic type.</summary>
