...
public static class TaskRepeater
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        while (options.MaximumIterations is null || iterations < options.MaximumIterations.Value)
        {
            ...
            try
            {
                if (options.ShouldContinue is not null && !options.ShouldContinue()) return;
            ...
            if (options.MaximumIterations is not null && iterations >= options.MaximumIterations.Value) return;
